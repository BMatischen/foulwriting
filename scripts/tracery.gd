...
"""This file's source code is from the godot-tracery repository created by Ian Sparks at 
	https://github.com/iansparks/godot_tracery. The source code in this file 
	is released under the Apache Licence, version 2.0.
